...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_default(
        ...
        KC_LEFT_CTRL, KC_LEFT_ALT, KC_SPACE, KC_ESC,
        ...
        KC_RIGHT_CTRL, MO(2), KC_RIGHT_GUI, KC_LEFT, KC_DOWN, KC_RIGHT
    ),
    [1] = LAYOUT_default(
        ___, ___, ___, ___, ___,
        ...
        ___, ___, ___, ___, ___, ___,
        MO(3), MO(2), ___, ___, ___, ___
    ),
    [2] = LAYOUT_default(
        ___, ___, ___, ___, ___,
        ___, DF(0), DF(1), ___, ___, ___, ___,
        ___, ___, ___, ___, ___, ___,
        ___, ___, ___, ___, ___, ___,
        ___, ___, ___, ___, ___, ___,
        ___, ___, ___, ___,
    ...
    [3] = LAYOUT_default(
        ...
        ___, ___, ___, ___, ___, ___, ___, ___,
        ___, KC_PRINT_SCREEN, KC_SCROLL_LOCK, KC_PAUSE, ___, ___, ___,
        ___, KC_INSERT, KC_I, KC_PAGE_UP, KC_MEDIA_PLAY_PAUSE, KC_MEDIA_PREV_TRACK, KC_MEDIA_NEXT_TRACK, ___,
        ___, KC_J, KC_K, KC_L, ___, ___, ___,
        ___, KC_AUDIO_MUTE, KC_AUDIO_VOL_DOWN, KC_AUDIO_VOL_UP, ___, ___,
        ___, ___, ___, ___, ___, ___
    ),
};
