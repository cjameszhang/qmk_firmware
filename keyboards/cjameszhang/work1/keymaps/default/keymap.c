...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_default(
        ...
        KC_LEFT_CTRL, KC_LEFT_GUI, KC_LEFT_ALT, KC_SPACE, KC_LEFT_CTRL,
        ...
        KC_RIGHT_CTRL, MO(1), KC_RIGHT_ALT, KC_RIGHT_GUI, KC_LEFT, KC_DOWN, KC_RIGHT
    ),
    [1] = LAYOUT_default(
        ...
        ___, KC_INSERT, KC_HOME, KC_PAGE_UP, KC_PRINT_SCREEN, KC_SCROLL_LOCK, KC_PAUSE, ___,
